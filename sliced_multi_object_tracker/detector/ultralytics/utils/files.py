...
def update_models(model_names=("yolov8n.pt",), source_dir=Path("."), update_names=False):
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils.files import update_models
    ...
    from sliced_multi_object_tracker.detector.ultralytics.nn.autobackend import default_class_names
