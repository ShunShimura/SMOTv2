...
from sliced_multi_object_tracker.detector.ultralytics.utils import LOGGER, TryExcept, ops, plt_settings, threaded
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils.plotting import save_one_box
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils.plotting import plot_results
