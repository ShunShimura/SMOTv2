...
from sliced_multi_object_tracker.detector.ultralytics.cfg import TASK2DATA, TASK2METRIC, get_save_dir
from sliced_multi_object_tracker.detector.ultralytics.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks
