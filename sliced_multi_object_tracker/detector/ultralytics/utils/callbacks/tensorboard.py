...
from sliced_multi_object_tracker.detector.ultralytics.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr
...
try:
    ...
    from sliced_multi_object_tracker.detector.ultralytics.utils.torch_utils import de_parallel, torch
