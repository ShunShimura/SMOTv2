...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils.checks import parse_requirements
...
def collect_system_info():
    ...
    from sliced_multi_object_tracker.detector.ultralytics.utils import ENVIRONMENT, is_git_dir
    from sliced_multi_object_tracker.detector.ultralytics.utils.torch_utils import get_cpu_info
...
def check_amp(model):
    ...
    Example:
        ...
        from sliced_multi_object_tracker.detector.ultralytics.utils.checks import check_amp
