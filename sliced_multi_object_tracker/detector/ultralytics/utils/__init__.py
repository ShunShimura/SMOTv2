...
from sliced_multi_object_tracker.detector.ultralytics import __version__
...
class ThreadingLocked:
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils import ThreadingLocked
...
class SettingsManager(dict):
    ...
    def __init__(self, file=SETTINGS_YAML, version="0.0.4"):
        ...
        from sliced_multi_object_tracker.detector.ultralytics.utils.torch_utils import torch_distributed_zero_first
