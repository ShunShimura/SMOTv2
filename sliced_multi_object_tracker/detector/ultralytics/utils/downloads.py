...
from sliced_multi_object_tracker.detector.ultralytics.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=(".DS_Store", "__MACOSX"), progress=True):
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=(".DS_Store", "__MACOSX"), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils.downloads import unzip_file
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils.downloads import get_google_drive_file_info
...
def safe_download(
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils.downloads import safe_download
...
def attempt_download_asset(file, repo="ultralytics/assets", release="v8.1.0", **kwargs):
    ...
    Example:
        ...
        ```
    """
    from sliced_multi_object_tracker.detector.ultralytics.utils import SETTINGS  # scoped for circular import
