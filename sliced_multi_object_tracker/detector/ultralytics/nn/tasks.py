...
from sliced_multi_object_tracker.detector.ultralytics.nn.modules import (
    AIFI,
    C1,
    C2,
    C3,
...
from sliced_multi_object_tracker.detector.ultralytics.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from sliced_multi_object_tracker.detector.ultralytics.utils.checks import check_requirements, check_suffix, check_yaml
from sliced_multi_object_tracker.detector.ultralytics.utils.loss import v8ClassificationLoss, v8DetectionLoss, v8OBBLoss, v8PoseLoss, v8SegmentationLoss, v10DetectLoss
from sliced_multi_object_tracker.detector.ultralytics.utils.plotting import feature_visualization
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from sliced_multi_object_tracker.detector.ultralytics.models.utils.loss import RTDETRDetectionLoss
...
def torch_safe_load(weight):
    ...
    """
    from sliced_multi_object_tracker.detector.ultralytics.utils.downloads import attempt_download_asset
