...
from sliced_multi_object_tracker.detector.ultralytics.cfg import TASK2DATA, get_cfg, get_save_dir
from sliced_multi_object_tracker.detector.ultralytics.hub.utils import HUB_WEB_ROOT
from sliced_multi_object_tracker.detector.ultralytics.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from sliced_multi_object_tracker.detector.ultralytics.utils import ASSETS, DEFAULT_CFG_DICT, LOGGER, RANK, SETTINGS, callbacks, checks, emojis, yaml_load
...
class Model(nn.Module):
    ...
    def _get_hub_session(model: str):
        ...
        from sliced_multi_object_tracker.detector.ultralytics.hub.session import HUBTrainingSession
    ...
    def track(
        ...
        **kwargs,
        ...
        if not hasattr(self.predictor, "trackers"):
            from sliced_multi_object_tracker.detector.ultralytics.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        """
        self._check_is_pytorch_model()
        from sliced_multi_object_tracker.detector.ultralytics.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from sliced_multi_object_tracker.detector.ultralytics.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        """
        from sliced_multi_object_tracker.detector.ultralytics.nn.autobackend import check_class_names
