...
from sliced_multi_object_tracker.detector.ultralytics.engine.predictor import BasePredictor
from sliced_multi_object_tracker.detector.ultralytics.engine.results import Results
from sliced_multi_object_tracker.detector.ultralytics.utils import ops
...
class RTDETRPredictor(BasePredictor):
    ...
    Example:
        ```python
        from sliced_multi_object_tracker.detector.ultralytics.utils import ASSETS
        from sliced_multi_object_tracker.detector.ultralytics.models.rtdetr import RTDETRPredictor
